...
public class BetterBadlandsFeatures {
    ...
    public static void onBiomeLoad(BiomeLoadingEvent event) {
        ...
        if (event.getName() != null && (event.getName().equals(Biomes.WOODED_BADLANDS_PLATEAU.getLocation()) || event.getName().equals(Biomes.MODIFIED_WOODED_BADLANDS_PLATEAU.getLocation()))) {
